...
class SummaryPage extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (summary != null && summary.isNotEmpty) ...[
                    // Grouping by year
                    ..._buildGroupedList(context, summary),
  ...
  List<Widget> _buildGroupedList(BuildContext context, List<Map<String, dynamic>> summary) {
    final theme = Theme.of(context);
    final colorScheme = theme.colorScheme;
    
    final Map<String, List<Map<String, dynamic>>> grouped = {};
    for (var item in summary) {
      final year = item['month'].toString().split('-')[0];
    ...
    for (var year in sortedYears) {
      widgets.add(_YearGroupHeader(year: year, color: colorScheme.secondary));
        ...
        child: Row(
          ...
          children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    AppHeading('.', size: AppHeadingSize.h1, color: colorScheme.primary),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.verified_user_rounded, size: 12, color: colorScheme.tertiary),
