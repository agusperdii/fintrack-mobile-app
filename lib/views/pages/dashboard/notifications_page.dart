        ...
        content: Column(
          ...
          children: [
            Text(
              notif.title,
              style: TextStyle(
                color: notif.isRead ? colorScheme.onSurfaceVariant : colorScheme.onSurface,
                fontSize: 14,
                fontWeight: FontWeight.bold,
              ),
            ),
            ...
            Text(
              notif.message,
              style: TextStyle(
                color: notif.isRead ? colorScheme.onSurfaceVariant : colorScheme.onSurface.withValues(alpha: 0.8),
                fontSize: 13,
                height: 1.5,
              ),
            ),
